...
import { YeosuDATA } from '../dosiDetails/yeosu'
  ...
  const list = YeosuDATA;
    ...
    return(
      ...
      <View>
        ...
        initialRegion={{latitude: 34.74183305113408,  longitude: 127.7434506015328, latitudeDelta: 0.03, longitudeDelta: 0.03,}}
        >
                  {list.map((item, index) => (
