...
//     const list2 = result.data.response.body.items.item.filter(dosilist => dosilist.audioTitle == audioTitle)
...
//   return (
//     <AudioDetails navigation={navigation} route={route} list={dosi}></AudioDetails>
//   )
